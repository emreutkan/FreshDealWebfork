...
import {
    ...
    getRestaurantThunk,
} from '@src/redux/thunks/restaurantThunks.js';
import {addFavoriteThunk, getFavoritesThunk, removeFavoriteThunk,} from "@src/redux/thunks/userThunks.js";
...
const restaurantSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getRestaurantThunk.fulfilled, (state, action) => {
                state.selectedRestaurant = action.payload;
            })
            ...
            .addCase(getRestaurantCommentAnalysisThunk.rejected, (state, action) => {
                state.commentAnalysisLoading = false;
                state.commentAnalysisError = action.payload;
            })
            ...
            .addCase(getRecentRestaurantsThunk.rejected, (state, action) => {
                state.recentRestaurantsLoading = false;
                state.recentRestaurantsError = action.payload;
            })
            .addCase(getRestaurantCommentsThunk.pending, (state) => {
                state.commentsLoading = true;
                state.commentsError = null;
            })
            .addCase(getRestaurantCommentsThunk.fulfilled, (state, action) => {
            ...
            .addCase(getFlashDealsThunk.rejected, (state, action) => {
                state.flashDealsLoading = false;
                state.flashDealsError = action.payload;
            });
    },
});
