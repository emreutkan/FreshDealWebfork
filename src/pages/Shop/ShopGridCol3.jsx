...
import assortment from "@src/images/assortment-citrus-fruits.png";
import productimg1 from "@src/images/product-img-1.jpg";
import productimg2 from "@src/images/product-img-2.jpg";
import productimg3 from "@src/images/product-img-3.jpg";
import productimg4 from "@src/images/product-img-4.jpg";
import productimg5 from "@src/images/product-img-5.jpg";
import productimg6 from "@src/images/product-img-6.jpg";
                                ...
                                <div>
                                    {loaderStatus ? (
                                        ...
                                        <>
                                            ...
                                            {/* row */}
                                            <div
                                                className="row g-4 row-cols-xl-3 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2">
                                                {/* col */}
                                                <div className="col">
                                                    {/* card */}
