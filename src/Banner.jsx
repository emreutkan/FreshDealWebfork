...
function Banner() {
    ...
    return (
<>
{isPopupOpen && (<Popup openPopup={openPopup} closePopup={closePopup} popupType={popupType} />)}
            ...
            <div className="container">
                <div className="menu_main">
                    ...
                    <div className="login_menu">
                        <ul>
                            <li><a href="#" onClick={(e) => { e.preventDefault(); openPopup('Login'); }}>Login</a></li>
                            <li><a href="#" onClick={(e) => { e.preventDefault(); openPopup('Register'); }}>Register</a></li>
