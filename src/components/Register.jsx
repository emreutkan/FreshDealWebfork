...
function Register({ account, accountFormUpdate, onUpdate, openPopup, closePopup }) {
                     ...
                     {({ isSubmitting }) => (
                        <Form className="register-form">
                           ...
                           <RegisterInput
                              ...
                              name="confirmPassword"
                           />
                           <button disabled={isSubmitting} className="register-button" type='submit'>Sign Up</button>
                        </Form>
                     )}
                  </Formik>

                  <div>If you're a member of FreshDeal&nbsp;
                     <button onClick={() => { closePopup(); openPopup("Login"); }}>Login</button>
                  </div>
               </div >
            )
         }
